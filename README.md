...
> **🧩 Feature-based modules** — Each domain (properties, leases, tenants) is self-contained with its own components, pages, services, and schemas. Cross-feature imports are blocked by ESLint boundary rules.
...
> **🛡️ Type-safe forms** — Every form uses Zod schemas as the single source of truth, shared between validation and TypeScript types.
...
Built with 💚 and precision by **Muneeb ul Hassan**
